...
delete files you intend to replace (be careful replacing *gitignore and gemlock file, also that gemfile that is replaced doesn't have outdated syntaxes)
...
Git Init
    Set up git link to new account
    Set up with heroku
    Set up Sendgrid
    Set up stp
    

Phase 3: Follow private message on adding keys including all written security measures
